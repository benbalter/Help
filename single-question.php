...
<div id="answer-list">
	...
	<?php /* Note: only changes were adding and removing filters… */ ?>
	<?php add_filter( 'get_user_metadata', 'hh_help_answer_comments', 10, 4 ); ?>
	<?php add_filter( 'parse_query', 'hh_help_dont_paginate_answers' ); ?>
	<?php the_answer_list(); ?>
	<?php remove_filter( 'parse_query', 'hh_help_dont_paginate_answers' ); ?>
	<?php remove_filter( 'get_user_metadata', 'hh_help_answer_comments' ); ?>
</div>
<?php } ?>
